...
export const GUEST_ACTIVE_QUESTS = [
  {
    id: 'g-q1',
    definitionId: 'def-1',
    title: 'Canopy Sound Map',
    category: 'Discovery',
    description: 'At a park or viewpoint, identify three distinct natural sounds and note where each came from.',
    progressValue: 1,
    targetValue: 1,
    unit: 'session',
    xpReward: 120,
  ...
  },
  {
    id: 'g-q2',
    definitionId: 'def-2',
    title: 'Neighbourhood Landmark Loop',
    category: 'Body',
    description: 'Walk a route connecting four local landmarks, public artworks, gardens, or heritage details.',
    progressValue: 3,
    targetValue: 4,
    unit: 'stops',
    xpReward: 80,
  ...
  },
  {
    ...
    category: 'Discovery',
    description: 'Photograph one building, monument, or streetscape transformed by late-afternoon light.',
    progressValue: 0,
    targetValue: 1,
    unit: 'photo',
    xpReward: 150,
  ...
  },
  {
    id: 'g-q4',
    definitionId: 'def-4',
    title: 'Habitat Trail Log',
    category: 'Discovery',
    description: 'Visit three different habitat types and log one observation from each.',
    progressValue: 2,
    targetValue: 3,
    unit: 'habitats',
    xpReward: 350,
...
export const GUEST_FRIENDS = [
  ...
  },
  {
    ...
    totalXp: 1640,
    streakDays: 9,
    rankTitle: 'Bronze Explorer II',
    status: 'accepted',
  },
  {
    userId: 'u-104',
    displayName: 'Aria Sunwalker',
    totalXp: 305,
    streakDays: 1,
    rankTitle: 'Novice I',
    status: 'accepted',
...
const LIBRARY_IMAGES = {
  retriever: '/assets/guest-library/retriever.jpg',
  tiger: '/assets/guest-library/tiger.jpg',
  mountains: '/assets/guest-library/mountains.jpg',
  waterfall: '/assets/guest-library/waterfall.jpg',
  butterfly: '/assets/guest-library/butterfly.jpg',
  fox: '/assets/guest-library/fox.jpg',
  aurora: '/assets/guest-library/aurora.jpg',
  canopy: '/assets/guest-library/canopy.jpg',
  maple: '/assets/guest-library/maple.jpg',
  dunes: '/assets/guest-library/dunes.jpg',
  wave: '/assets/guest-library/wave.jpg',
  lake: '/assets/guest-library/lake.jpg',
  horses: '/assets/guest-library/horses.jpg',
  owl: '/assets/guest-library/owl.jpg',
  mushrooms: '/assets/guest-library/mushrooms.png',
};
...
export const GUEST_COMMUNITY_POSTS = [
  ...
  },
  {
    id: 'gp-6',
    userId: 'u-101',
    author: { userId: 'u-101', displayName: 'Lyra Moonweaver', totalXp: 9840, rankTitle: 'Gold Explorer III' },
    cardId: 'cap-7',
    discovery: { itemName: 'Northern Lights', cardTitle: 'Aurora Borealis', rarityTier: 'S', rarityGrade: 'S', rarityStars: 5, speciesId: 'sky-aurora', element: 'Sky', imageRef: LIBRARY_IMAGES.aurora, capturedAt: new Date(Date.now() - 7200000).toISOString() },
    caption: 'The sky put on a show above the escarpment.',
    hashtags: ['#night', '#sky'],
    placeLabel: 'Nandi Hills summit',
  ...
  },
  {
    ...
    cardId: 'cap-13',
    discovery: { itemName: 'Owl in Tree', cardTitle: 'Silent Watcher', rarityTier: 'A', rarityGrade: 'A', rarityStars: 4, speciesId: 'sky-owl', element: 'Sky', imageRef: LIBRARY_IMAGES.owl, capturedAt: new Date(Date.now() - 18000000).toISOString() },
    caption: 'Evening walk win — the resident owl on the old rain tree.',
    hashtags: ['#birding', '#lalbagh'],
  ...
  },
  {
    id: 'gp-7',
    userId: 'u-102',
    author: { userId: 'u-102', displayName: 'Theron Ironheart', totalXp: 1640, rankTitle: 'Bronze Explorer II' },
    cardId: 'cap-3',
    discovery: { itemName: 'Misty Mountains', cardTitle: 'Cloud Piercer', rarityTier: 'S', rarityGrade: 'S', rarityStars: 5, speciesId: 'earth-mountain-vista', element: 'Earth', imageRef: LIBRARY_IMAGES.mountains, capturedAt: new Date(Date.now() - 28800000).toISOString() },
    caption: 'Ridge-run reward: clouds sitting right on the hills.',
    hashtags: ['#trail', '#clouds'],
    placeLabel: 'Bannerghatta ridge',
    gps: { lat: 12.8004, lng: 77.563 },
    visibility: 'public',
    likeCount: 14,
    commentCount: 1,
    viewerLiked: false,
  ...
  },
  {
    id: 'gp-8',
    userId: 'u-104',
    author: { userId: 'u-104', displayName: 'Aria Sunwalker', totalXp: 305, rankTitle: 'Novice I' },
    cardId: 'cap-8',
    discovery: { itemName: 'Rainforest Canopy', cardTitle: 'Emerald Roof', rarityTier: 'C', rarityGrade: 'C', rarityStars: 2, speciesId: 'grass-canopy', element: 'Grass', imageRef: LIBRARY_IMAGES.canopy, capturedAt: new Date(Date.now() - 36000000).toISOString() },
    caption: 'First capture ever — the light through the leaves.',
    hashtags: ['#firstfind', '#canopy'],
    placeLabel: 'Cubbon Park',
    gps: { lat: 12.9763, lng: 77.5924 },
    visibility: 'public',
    likeCount: 6,
    commentCount: 1,
    viewerLiked: false,
